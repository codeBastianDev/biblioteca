<?php
$modulo = "Creacion de inscripción";
include("../include/header.php");
include("../class/helper.php");

$anios  = ($_GET['id_ins'] != 0) ? ["i.id ={$_GET['id_ins']}"]:array();
...
//                         array('e.foto,e.nombre,e.apellido,i.id_grado, i.id_anio,g.nombre grado,p.id id_factura,e.id as id_estudiante'));

$estDt = $db->cargar($_GET['id_estudiante']);
...
<body class="g-sidenav-show bg-gray-100">
  <div class="position-absolute w-100 min-height-300 top-0" style="background-image: url('../assets/img/banner_estudiante.webp'); background-position-y: 50%;">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <p class="text-uppercase text-sm">Matriculación</p>

              <form id="formulario" method="post" action="../controller/newCuota.php" >
                <!-- <input type="hidden" name="id_factura" value="<?=(isset($est[0]['id_factura'])) ? "{$est[0]['id_factura']}" : 0 ?>"> -->
                <input type="hidden" name="id_estudiante" value="<?=(isset($est[0]['id'])) ? "{$est[0]['id']}" : 0 ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 ">
                    <div class="form-group">
                      ...
                      <select name="anio" id="anio" class="form-control" required>
                        <option value="">Seleccione</option>
                        <?php 
                        foreach (($d = new db('anio a'))->joinQuery(
                          array('inscripcion i'),
                          array(2),
                          array('a.id != i.id_anio'),
                          $anios,
                          array('a.id,a.nombre'),'GROUP By a.id') as $v) {
                  ...
                  <div class="col-md-3 ">
                    <div class="form-group">
                      ...
                      <select name="inscripcion" id="matriculacion" class="form-control" required>
                        <option value="">Seleccione</option>
                        <?php
                  ...
                  <div class="col-md-3 ">
                    <div class="form-group">
                      ...
                      <select name="escolaridad" id="precioEscolarida" class="form-control" required>
                        <option value="">Seleccione</option>
                        <?php
