<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="" target="_blank">
      <img src="../assets/img/Logo2.jpeg" class="navbar-brand-img h-100" alt="main_logo">
      <span class="ms-1 font-weight-bold">Biblioteca</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link " href="../pages/estudiante.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-hat-3 text-warning text-sm opacity-10"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link " href="../pages/cuadre.php">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
